...
const InputBar = ({ currentMessage, setCurrentMessage, onSubmit } : {currentMessage:string,setCurrentMessage: React.Dispatch<React.SetStateAction<string>> , onSubmit:any}) => {
